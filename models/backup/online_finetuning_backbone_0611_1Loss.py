...
class Online_Finetuning_Backbone(models.BaseModel):
    ...
    def __init__(self, cfg, data_cfg, run, **kwargs):
        ...
        self._component_loss_keys: list = ['loss_slice']
        ...
        * Volume reconstruction runs under ``torch.no_grad()``.
        ...
        for _attempt in range(max_reco_attempts):
            ...
            if losses is not None:
                ...
                self._component_loss_keys = list(losses.keys())
    ...
    def eval_loss(self, epoch_info, sample_dict):
        ...
        or optimizer.step().  Used for computing test/val loss curves.

        Returns:
            dict[str, Tensor]  {loss_name: detached scalar, ...}
                Same keys as train() except 'grad_norm' is absent.
        """
