...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--MINIBATCH_SIZE', type=int,default=1,help='input batch size')
        ...
        self.parser.add_argument('--NUM_EPOCHS',type =int,default=int(1),help='# of iter to lin')
