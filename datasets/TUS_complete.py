...
__all__ = ['TUS_complete']


class TUS_complete(datasets.BaseDataset):
    ...
    def load(self):
        ...
        h5_path_list, target_point_list, target_dof_list = [], [], []
    ...
    def __getitem__(self, index):
        ...
        target_point = self.pad(target_point, self.cfg.seq_len)
