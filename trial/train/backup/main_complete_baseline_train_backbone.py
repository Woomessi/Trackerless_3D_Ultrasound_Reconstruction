...
class Main(object):
    ...
    def __init__(self):
        ...
        self.dataset_cfg = datasets.functional.common.more(configs.BaseConfig('/home/wu/Documents/projects/cloned_repositories/RecON/res/datasets/TUS_complete.json'))
