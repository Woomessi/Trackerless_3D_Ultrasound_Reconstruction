...
def main():
    ...
    slice = my_utils.get_slice(volume_up, slicer_biased, source.shape[-2:], scale_h=scale_h,
                               scale_w=scale_w)  # (1, N, 1, H_down, W_down)
    ...
    # add_series_rects(plotter, series_biased, indices=[0, 300, N - 1], colors='red', opacity=1, frames=source_0)
